...
import { SMS_DELTA_BETWEEN_DATES_IN_MONTHS, TWELVE_HOURS } from 'store/NewCampaign/channels/constants';
import NewCampaign from 'store/mobx/NewCampaign';

export const useSmsDatesValidators = () => {
  ...
  const countMaxEndDate = (dateStart) => {
    ...
    if (dateStart) {
      const dateWithAdditionalMonths = addMonths(new Date(dateStart), SMS_DELTA_BETWEEN_DATES_IN_MONTHS);
    ...
    return addMonths(countMaxStartDate(), SMS_DELTA_BETWEEN_DATES_IN_MONTHS);
  };
